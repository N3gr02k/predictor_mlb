...
from src.app import get_cached_predictions, app
...
def pre_populate_cache_for_today():
    ...
    with app.app_context():
        ...
        # Simplemente llamamos a la función que ya tiene la lógica de caché.
        # Esto calculará las predicciones si la caché está vacía, o no hará nada si ya está llena.
        get_cached_predictions(today_str)
